        ...
        <div>
            ...
            <div style={{backgroundImage: `url(/assets/home-hero-art.png)`}} className="min-h-[870px] bg-[#003358] bg-cover bg-no-repeat">
                <div className="container mx-auto text-white pt-[220px]">
                    <div className="">
                    <p className="text-xl leading-6">Product Growth Solution in A Single Platform.</p>
                    <p className="text-[52px] font-bold leading-[63px] mt-2.5">AI Powered Salesbook <br/>& Inventory <br/>Management</p>
                    <p className="text-[30px] font-bold leading-[37px] text-[#B38B00] mt-2.5">High Quality Custom Sales Software for <br/>your business.</p>
            ...
            {/* ❤️‍🔥 Second Section */}
            <div className="h-[622px] shadow-lg bg-[#B38B00] bg-no-repeat bg-contain bg-right"  style={{backgroundImage: `url(/assets/home-second-art.png)`}} >

            <div className="container mx-auto relative -top-[180px]">
                 {/* ❤️‍🔥 Image grid */}
                 <div className="grid grid-cols-3">
                    <div className="div col-span-1 flex justify-center">
                ...
                <div className="mt-[36px]">
                    <p className="text-[40px] leading-[49px] font-bold text-white">We are the solution for Sales<br/> Tracking problems</p>
                    <p className="text-[22px] text-white mt-[22px]">SalesLine Electronic Salesbook and Inventory management Solution eliminate paper-based processes in organizations' sales and inventory management, it manages sales and expenditure information and allows administrators to make well-informed managerial decisions, thereby automating bookkeeping processes</p>
            ...
            {/* ❤️‍🔥 Third Section */}
            <div className="min-h-[1285px] pb-[64px] bg-[#003358] bg-no-repeat bg-cover bg-right" style={{backgroundImage: `url(/assets/home-3rd-art.png)`}}>
                <div className="container mx-auto grid grid-cols-10 gap-10 h-full">
                    <div className=" relative -top-12 col-span-5 flex justify-center">
                        <img src="/assets/home-3rd-img.png" className="h-[825px] w-[530px]" alt="" />
                    </div>

                    {/* Content */}
                    <div className="text-white col-span-5">
                        <h2 className="text-[40px] font-bold leading-[49px] mt-[50px]">Features</h2>
                        <ol className="text-[20px] leading-[24px] font-bold grid gap-8 mt-10">
                        ...
                        <div className="grid grid-cols-2 gap-[21px] mt-[42px] text-white">
                            <div style={{boxShadow: 'box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25)'}} className="col-span-1 px-3 pt-5 pb-11 bg-[#B38B00] rounded-[25px]">
            ...
            {/* ❤️‍🔥 News Section */}
            <div className="min-h-[622px] pb-[123px] text-white bg-[#B38B00] bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(/assets/home-4th-news-art.png)`}}>
                <div className="container mx-auto">
                    <h1 className="text-[64px] leading-[78px] font-black relative -top-11">In The News</h1>
                    
                    <div className="bg-[#D9D9D9] bg-opacity-20 px-[50px] py-[28px] rounded-[9px]">
                        <h1 className="text-[22px] leading-[24px] font-bold">SalesLine Revolutionising Businesses With LLM Powered Chatbots</h1>
                        <p className="mt-2.5 text-[18px]">SalesLine Technology Enterprises and partner company Techline Communications, an indigenous information technology (IT) firm, has added an innovative solution that will help corporate organizations in customer relations and engagement. Known as LLM Powered Chatbot Building Service powered by ChatGPT. This solution is harnessing the potential of machine learning algorithms, natural language processing, and artificial intelligence, this solution empowers businesses to unlock the full potential of their data and revolutionize their operations</p>
                        <div className="flex justify-end">
                            <p className="font-medium text-[20px] bg-none">Read More...</p>
                        </div>
                    </div>

                    <div className="bg-[#D9D9D9] bg-opacity-20 px-[50px] py-[28px] rounded-[9px] mt-[36px]">
                        <h1 className="text-[22px] leading-[24px] font-bold">SalesLine Revolutionising Businesses With LLM Powered Chatbots</h1>
                        <p className="mt-2.5 text-[18px]">SalesLine Technology Enterprises and partner company Techline Communications, an indigenous information technology (IT) firm, has added an innovative solution that will help corporate organizations in customer relations and engagement. Known as LLM Powered Chatbot Building Service powered by ChatGPT. This solution is harnessing the potential of machine learning algorithms, natural language processing, and artificial intelligence, this solution empowers businesses to unlock the full potential of their data and revolutionize their operations</p>
                        <div className="flex justify-end">
                            <p className="font-medium text-[20px] bg-none">Read More...</p>
